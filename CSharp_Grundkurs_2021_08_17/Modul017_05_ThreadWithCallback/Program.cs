...
namespace Modul017_05_ThreadWithCallback
{
    class Program
    {
    ...
    //Wird als Return-Object verwendet 
    ...
    public class ThreadWithState
    {
        ...
        // task is complete.
        private ExampleCallback callback; //hat den Methodenzeiger von: public static void ResultCallback(MyReturnObject myReturnObject)
